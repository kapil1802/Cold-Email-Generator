...
class Chain:
    ...
    def extract_jobs(self, cleaned_text):
        ...
        try:
            ...
            raise OutputParserException("Context is too big. unable to parse job.")
    ...
    def write_mail(self, job, links):
        prompt_email = PromptTemplate.from_template(
            ...
            ### INSTRUCTION:
            You are Kapil, a business development executive at ABC. ABC is an AI & Software Consulting company dedicated to facilitating
